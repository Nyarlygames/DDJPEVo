...
begin
  ...
  begin
    ...
    if (DispRectPos.X > MAX_WIDTH-50) or (DispRectPos.X < 10) then
    begin
      if (DispRectPos.X > MAX_WIDTH-50) then
    ...
    if (DispRectPos.Y > MAX_HEIGTH-50) or (DispRectPos.Y < 10) then
    begin
      if (DispRectPos.Y > MAX_HEIGTH-50) then
      begin  //limite en bas
...
const
  ...
  rose : TColor4 = ($FFFF2FD4,$FFFF2FD4,$FFFF2FD4,$FFFF2FD4);
  red : TColor4 = ($FFFF111A,$FFFF111A,$FFFF111A,$FFFF111A) ;
  turquoise : TColor4 = ($FF11ECFF,$FF11ECFF,$FF11ECFF,$FF11ECFF) ;
  green : TColor4 = ($FF11FF18,$FF11FF18,$FF11FF18,$FF11FF18) ;
  orange : TColor4 = ($FFFFA914,$FFFFA914,$FFFFA914,$FFFFA914) ;
  purple : TColor4 = ($FFC935FE,$FFC935FE,$FFC935FE,$FFC935FE) ;
...
var
  ...
  flashy_color_tab : array[0..5] of TColor4 ;
begin
Randomize;
flashy_color_tab[0] := rose ;
flashy_color_tab[1] := red ;
flashy_color_tab[2] := turquoise ;
flashy_color_tab[3] := green ;
flashy_color_tab[4] := orange ;
flashy_color_tab[5] := purple ;
  ...
  begin
    ...
    TexMap(pBounds4(0, 300, AsImage.Texture[0].Size.X, AsImage.Texture[0].Size.Y),
...
begin
  //Déclenchement du rendu sur fond noir
