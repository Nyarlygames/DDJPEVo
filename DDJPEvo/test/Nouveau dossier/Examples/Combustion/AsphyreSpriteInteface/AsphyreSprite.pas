...
uses
   ...
   AsphyreImages, Vectors2, AsphyreEffects,SpriteInterface, Controls, Messages, Forms;
...
type
 ...
 public
      ...
      procedure OnMouseClick; virtual;
...
begin
     ...
     FEngine.Canvas.DrawEx(TAsphyreImage(FEngine.Image.Image[ImageName]),
                           FPatternIndex,
                           Trunc(FX + FWorldX - Trunc(FEngine.FWorldX)),
                           Trunc(FY + FWorldY - Trunc(FEngine.FWorldY)),
                           clWhite4,
                           FDrawFx);
end;
...
begin
     ...
     case FDrawMode of
          //1 color mode
          0: FEngine.Canvas.DrawColor1(
                         TAsphyreImage(FEngine.Image.Image[ImgName]),
                         FPatternIndex,
           ...
           1: FEngine.Canvas.DrawRotateC(
            ...
            3: FEngine.Canvas.DrawTransForm(
                         TAsphyreImage(FEngine.Image.Image[ImgName]),
                         FPatternIndex,
            ...
            4: FEngine.Canvas.DrawTransForm(
                         TAsphyreImage(FEngine.Image.Image[ImgName]),
                         FPatternIndex,
                         Trunc(FX1 + FWorldX + FOffsetX - Trunc(FEngine.FWorldX)), Trunc(FY1 + FWorldY + FOffsetY - Trunc(FEngine.FWorldY)),
                         Trunc(FX2 + FWorldX + FOffsetX - Trunc(FEngine.FWorldX)), Trunc(FY2 + FWorldY + FOffsetY - Trunc(FEngine.FWorldY)),
...
begin
     Result:= PtInRect(Rect(FActiveRect.Left-Trunc(FEngine.WorldX),
                       ...
                       Point(Mouse.CursorPos.X,Mouse.CursorPos.Y));
end;
...
procedure TSpriteEx.OnMouseClick;
begin
   //
end;
               ...
               case Msg.message of
                     ...
                     begin
                          ...
                          if TSpriteEx(Items[i]).FMouseDownFlag=True then
                              TSpriteEx(Items[i]).OnMouseDrag;
                     end;
                     WM_LBUTTONDOWN:
                     begin
                          TSpriteEx(Items[i]).OnMouseClick;
