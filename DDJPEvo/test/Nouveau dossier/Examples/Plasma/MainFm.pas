...
uses
  ...
  Dialogs, ComCtrls, AsphyreDevices, AsphyrePalettes, AsphyreDef;
...
begin
 ...
 with Sender.Fonts.Font['x/tranceform'] as TAsphyreBitmapFont do
  begin
   Kerning   := -2;
   DropShadow:= True;

   TextOutFx('Frame Rate: ' + IntToStr(Timer.FrameRate), 4, 4, $FF9500FF,
    $FFFFFFFF);
  end;
end;
