...
{ This file has been modified slightly to use the existing
  file "asphyrezlib.pas" provided in Asphyre instead of the
  original "zlibpas.pas" with the permission of Gustavo Daud. }
