...
//---------------------------------------------------------------------------
uses
 Windows, Direct3D9, D3DX9, Types, Classes, SysUtils, AsphyreAsserts,
 MediaUtils, AsphyreArchives, Vectors2
...
//---------------------------------------------------------------------------
 ...
 public
  ...
  function CoordToLogical(const Coord: TPoint): TPoint2; virtual;

  // Converts logical coordinates [0..1] to pixel coordinates.
  function LogicalToCoord(const Coord: TPoint2): TPoint; virtual;
...
//---------------------------------------------------------------------------
 ...
 public
  ...
  property OrigSize: TPoint read FOrigSize write FOrigSize;

  // The size of individual sub-images inside the texture.
  property PatternSize: TPoint read FPatternSize write FPatternSize;
  ...
  function CoordToLogical(const Coord: TPoint): TPoint2; override;
  function LogicalToCoord(const Coord: TPoint2): TPoint; override;
...
//---------------------------------------------------------------------------
function TAsphyreCustomTexture.LogicalToCoord(const Coord: TPoint2): TPoint;
begin
...
//---------------------------------------------------------------------------
function TAsphyreCustomTexture.CoordToLogical(const Coord: TPoint): TPoint2;
begin
...
//---------------------------------------------------------------------------
function TAsphyrePlainTexture.LogicalToCoord(const Coord: TPoint2): TPoint;
begin
...
//---------------------------------------------------------------------------
function TAsphyrePlainTexture.CoordToLogical(const Coord: TPoint): TPoint2;
begin
  ...
  with TAsphyreDevice(Device) do
   begin
    Result:= Succeeded(Dev9.CreateDepthStencilSurface(FSize.X, FSize.Y,
     Params.AutoDepthStencilFormat, Params.MultiSampleType,
      Params.MultiSampleQuality, True, DepthStencil, nil));
