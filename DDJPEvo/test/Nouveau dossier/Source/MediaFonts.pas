unit MediaFonts;
//---------------------------------------------------------------------------
// MediaFonts.pas                                       Modified: 21-Jan-2007
...
//---------------------------------------------------------------------------
uses
 Windows, Direct3D9, D3DX9, Types, SysUtils, AsphyreXML, AsphyreDef,
 MediaUtils
...
//---------------------------------------------------------------------------
 ...
 TFontDesc = record
  ...
  // values specific to system fonts
  FontName   : string;
  FontSize   : Cardinal;
  Weight     : Cardinal;
  Charset    : Cardinal;
...
begin
 ...
 Desc.FontName  := LowerCase(Node.FieldValue['name']);
 Desc.FontSize  := ParseCardinal(LowerCase(Node.FieldValue['size']), 0);
 Desc.Weight    := ParseFontWeight(LowerCase(Node.FieldValue['weight']));
 Desc.Charset   := ParseFontCharset(LowerCase(Node.FieldValue['charset']));
 Desc.Quality   := ParseFontQuality(LowerCase(Node.FieldValue['quality']));
