...
//---------------------------------------------------------------------------
uses
 Classes, SysUtils, Math, StreamEx, TrueColors, AsphyreDef;
...
begin
 ...
 Result.r:= CubicTheta(Color0.r, Color1.r, Color2.r, Color3.r, Alpha);
 Result.g:= CubicTheta(Color0.g, Color1.g, Color2.g, Color3.g, Alpha);
 Result.b:= CubicTheta(Color0.b, Color1.b, Color2.b, Color3.b, Alpha);
 Result.a:= CubicTheta(Color0.a, Color1.a, Color2.a, Color3.a, Alpha);
