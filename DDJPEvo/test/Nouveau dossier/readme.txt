Asphyre 4 beta snapshot dated 23-Jan-2007
...
file to run. It is in \DLLs folder. This file is provided only for
testing purposes since Microsoft EULA prohibits the distribution of
